 ...
 *
 * @ORM\Table(name="types__languages")
 * @ORM\Entity(repositoryClass="Esolving\Eschool\CoreBundle\Repository\TypeLanguageRepository")
 */
class TypeLanguage
{
    /**
     ...
     * Set type
     *
     * @param Esolving\Eschool\CoreBundle\Entity\Type $type
     * @return Language
     */
    public function setType(\Esolving\Eschool\CoreBundle\Entity\Type $type = null)
    {
        $this->type = $type;
